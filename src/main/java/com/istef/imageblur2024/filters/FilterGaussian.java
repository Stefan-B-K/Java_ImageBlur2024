 ...
 */
public class FilterGaussian implements ImgFilter {
    /**
     ...
     */
    protected static int CLAMP_EDGES = 1;

    /**
     * Wrap pixels off the edge to the opposite edge.
     */
    protected static int WRAP_EDGES = 2;
    ...
    /**
     * Construct a Gaussian Blur filter with blur radius of 5 pixels.
     */
    protected FilterGaussian() {
        this.setRadius(5);
    }

    /**
     * Construct a Gaussian Blur filter.
     ...
     */
    public FilterGaussian(int radius) {
        setRadius(radius);
    }
     ...
     */
    private static void convolveAndTranspose(Kernel kernel, int[] inPixels, int[] outPixels, int width, int height, boolean alpha, boolean premultiply, boolean unpremultiply, int edgeAction) {
